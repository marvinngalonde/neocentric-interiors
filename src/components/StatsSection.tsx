        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="text-sm font-['League_Spartan'] text-gray-600 tracking-wider">
                Elegance • Timeless
              </div>
              ...
              <Button variant="default" className="bg-foreground font-['League_Spartan'] hover:bg-foreground/90 text-white px-8 py-3">
                <a href="#contact">
                Contact Us
                </a>
              </Button>
